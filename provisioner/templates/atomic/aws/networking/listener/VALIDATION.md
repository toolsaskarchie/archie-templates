# Listener Atomic Block - Validation Report

**Template Path**: `atomic/aws/networking/listener/`  
...
1. ✅ Listener - `aws:lb:Listener` (via `ListenerComponent`)
   - Configuration: load_balancer_arn, port, protocol, default_actions
   - Optional: certificate_arn (for HTTPS/TLS), ssl_policy
...
|-----------|-------------|-------------|-------|
| load_balancer_arn | ✅ Required | ✅ Required | ✅ |
| target_group_arn | ✅ Required | ✅ Required | ✅ |
| port | ✅ Default: 80 | ✅ Default: 80 | ✅ |
| protocol | ✅ Default: HTTP | ✅ Default: HTTP | ✅ |
| certificate_arn | ✅ Optional | ✅ Optional | ✅ |
| ssl_policy | ✅ Default: ELBSecurityPolicy-2016-08 | ✅ Default: ELBSecurityPolicy-2016-08 | ✅ |
...
- [x] Uses `ListenerComponent` (not raw Pulumi resources)
...
- [x] Resource names are identical (listener)
- [x] Resource type is identical (aws:lb:Listener)
