    ...
    def create(self) -> Dict[str, Any]:
        ...
        if vpc_mode == 'new':
            ...
            if self.cfg.ssh_access_ip:
                ...
                access_sg_name = (self.config.get('access_sg_name') or self.config.get('parameters', {}).get('access_sg_name')) or namer.security_group(purpose="access")
        ...
        if self.cfg.enable_ssm:
            role_name = (self.config.get('iam_role_name') or self.config.get('parameters', {}).get('iam_role_name')) or namer.iam_role("ec2", preset_for_naming)
            ...
            profile_name = (self.config.get('iam_profile_name') or self.config.get('parameters', {}).get('iam_profile_name')) or namer.iam_profile("ec2", preset_for_naming)
        ...
        for idx in range(1, self.cfg.instance_count + 1):
            ...
            if self.cfg.instance_count == 1 and (self.config.get('instance_name_generated') or self.config.get('parameters', {}).get('instance_name_generated')):
                name_final = (self.config.get('instance_name_generated') or self.config.get('parameters', {}).get('instance_name_generated'))
            else:
