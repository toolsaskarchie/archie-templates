...
""")
        ...
        pulumi.export("eks_cluster_role_name", cluster_role_name)
        pulumi.export("eks_node_role_name", node_role_name)
        pulumi.export("eks_instance_profile_name", profile_name)
