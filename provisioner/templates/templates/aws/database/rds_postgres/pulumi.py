...
class RDSPostgresTemplate(InfrastructureTemplate):
    ...
    def create(self) -> Dict[str, Any]:
        ...
        if not sg_id:
            ...
            sg_name = (self.config.get('db_sg_name') or self.config.get('parameters', {}).get('db_sg_name')) or namer.security_group(purpose="db", ports=[5432], service="postgres")
        ...
        self.db_instance = factory.create(
            ...
            multi_az=self.get_bool('multi_az', True),
            storage_type="gp3",
