...
class VPCProdTemplate(InfrastructureTemplate):
    ...
    def create(self) -> Dict[str, Any]:
        ...
        vpc_resource_name = vpc_name or namer.vpc(cidr=cidr_block)
        self.vpc = factory.create(
            "aws:ec2:Vpc",
            vpc_resource_name,
            cidr_block=cidr_block,
            enable_dns_support=self.cfg.get('enable_dns_support', True),
            enable_dns_hostnames=self.cfg.get('enable_dns_hostnames', True),
