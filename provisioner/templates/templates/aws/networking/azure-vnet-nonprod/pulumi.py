...
- DDoS Protection Standard (+$2,944/mo)
"""
...
class AzureVNetNonProdTemplate(InfrastructureTemplate):
    ...
    def create_infrastructure(self):
        ...
        if enable_ddos:
            vnet_args['enable_ddos_protection'] = True
        ...
        pulumi.export('ddos_protection_enabled', enable_ddos)
        if enable_nat:
    ...
    def get_config_schema(cls):
        return {
            'project_name': {'type': 'string', 'description': 'Project name for resource naming', 'default': 'myproject'},
            'environment': {'type': 'string', 'description': 'Environment (dev/staging/prod)', 'default': 'dev'},
            'location': {'type': 'string', 'description': 'Azure region for deployment', 'default': 'eastus'},
            'vnet_cidr': {'type': 'string', 'description': 'VNet CIDR block', 'default': '10.0.0.0/16'},
            'public_subnet_cidr': {'type': 'string', 'description': 'Public subnet CIDR', 'default': '10.0.1.0/24'},
            'private_subnet_cidr': {'type': 'string', 'description': 'Private subnet CIDR', 'default': '10.0.2.0/24'},
            'enable_nat_gateway': {'type': 'boolean', 'description': 'Enable NAT Gateway for private subnet outbound', 'default': True},
            'enable_ddos_protection': {'type': 'boolean', 'description': 'Enable DDoS Protection Standard on VNet', 'default': False},
        }